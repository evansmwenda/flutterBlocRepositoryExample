...
class Nation {
  ...
  Nation.fromJson(Map<String, dynamic> json) {
    imageUrls = json['imageUrls'] != null
        ? new ImageUrlsNation.fromJson(json['imageUrls'])
        : null;
    abbrName = json['abbrName'];
    id = json['id'];
    imgUrl = json['imgUrl'];
...
class ImageUrlsNation {
  String small;
  String medium;
  String large;

  ImageUrlsNation({this.small, this.medium, this.large});

  ImageUrlsNation.fromJson(Map<String, dynamic> json) {
    small = json['small'];
    medium = json['medium'];
    large = json['large'];
  }
...
class Club {
  ...
  Club.fromJson(Map<String, dynamic> json) {
    imageUrls = json['imageUrls'] != null
        ? new ImageUrlsClub.fromJson(json['imageUrls'])
        : null;
    abbrName = json['abbrName'];
    id = json['id'];
    imgUrl = json['imgUrl'];
...
class ImageUrlsClub {
  ...
  ImageUrlsClub({this.dark, this.light});

  ImageUrlsClub.fromJson(Map<String, dynamic> json) {
